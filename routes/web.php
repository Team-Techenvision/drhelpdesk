...
Route::middleware(['admin','auth'])->group(function() {
	...
	//karnal shop order shop id 101  
	Route::get('/view-shop-order-karnal', 'admin\OrderController@viewOrderkarnal');
	Route::get('/view-shop-user-invoice/{order_id}', 'admin\OrderController@cust_invoice_details');
	...
	Route::get('csv_file/export', 'admin\AdminController@export')->name('export'); 
		...
		Route::get('add_multiple_stock','admin\AdminController@Add_multiple_stock');
		Route::post('br-product-detail','admin\AdminController@br_product_detail');
		Route::post('submit-multiple-stock', 'admin\AdminController@submit_multiple_stock');
