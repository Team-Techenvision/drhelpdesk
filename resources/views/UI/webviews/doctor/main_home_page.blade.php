                    ...
                    <div class="row border-row1">
                        ...
                        <div class="col-lg-2 col-sm-4 col-6 p-0">
                            ...
                            <div class="product-box" id="tab-4">
                                <div class="img-block">								
                                    <a href="{{url('/product-detail/'.$row->products_id)}}"><img src="{{url($row->product_image)}}" class=" img-fluid bg-img" alt="elle"></a>
                                    ...
                                    <div class="cart-details">
                                        ...
                                        @php 
                                            ...
                                            if($result1 == 0){
                                        @endphp   
                                        <a href="{{url('add-wishlist/'.$row->products_id.'/'.$user_id)}}">  <button title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></button></a>
                                        @php 
                                            }
                                        @endphp
                                        @endif
