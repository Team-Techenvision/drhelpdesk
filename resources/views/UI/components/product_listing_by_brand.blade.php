                           ...
                           <div class="row">
                              <div class="col-12 collection-collapse show d-md-flex bg-light pt-2 pl-0 min-vh-100" id="sidebar">
                                 <ul class="nav flex-column flex-nowrap overflow-hidden">
                                    ...
                                    <li class="nav-item">
                                       <a class="nav-link nav-link2 collapsed text-truncate" href="#submenu1" data-toggle="collapse" data-target="#submenu1"><span class=" d-sm-inline">Makeup</span></a>
                                       <div class="collapse" id="submenu1" aria-expanded="false">
                                          <ul class="flex-column pl-2 nav">
                                             <li class="nav-item">
                                                <a class="nav-link nav-link2 collapsed py-1" href="#submenu1sub1" data-toggle="collapse" data-target="#submenu1sub1"><span>Lips</span></a>
                     ...
                     <div class="collection-collapse-block-content">
                        ...
                        @foreach($brand1 as $r1) 
                           ...
                           <div class="custom-control custom-checkbox collection-filter-checkbox">
                              <input type="checkbox" class="custom-control-input" name="brand[]" value="{{$brand2->id}}" id="check_<?php echo $i; ?>" >
                                 ...
                                 <div class="col-12">
                                    <div class="product-filter-content">
                                       ...
                                       <div class="product-page-filter">
                                          <select>
                                             <option value="High to low">Sorting by</option>
                                             <option value="Low to High">Low - High</option>
                                             <option value="Low to High">High - Low</option>
                                          </select>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-xl-3 col-md-4 col-6 col-grid-box">
                                    <div class="product-box">
                                       ...
                                       ?>
                                          ...
                                          <a href="{{url('/product-detail/'.$row->products_id)}}"><img src="{{url($product_img->product_image)}}" class=" img-fluid bg-img" alt="Product"></a>
