         ...
         <div class="col-12">
            <nav aria-label="breadcrumb" class="theme-breadcrumb">
               <ol class="bread breadcrumb">
				  ...
				  <li class="breadcrumb-item " ><a href="#">Elle18 LIPSTICK</a></li>
				   <li class="breadcrumb-item " ><a href="#">Elle 18 Color Pops Matte Lip Color - Rose Day</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12 order-up">
                        ...
                        <div><img src="../assets/images/product/shades.jpg" alt="shades" class="img-fluid ">
						
						</div>
                        <br>
							<div class="col-12" style="text-align: start;align-content: center;font-weight: 600;"> Select your skin tone&nbsp;
				<a href="#"><img src="../assets/images/product/skin-tone.jpg" alt="shades" class="img-fluid "></a>&nbsp;&nbsp;&nbsp;<a href="product-detail.php"><i class=" fa-2x fa fa-times-circle-o skin-cros" aria-hidden="true"></i></a>
				</div>
                ...
                <div class="col-lg-6 rtl-text">
                    <div class="product-right">
                        <h2 style="color: #1d99b5;">Colorbar Ultimate 8Hrs Stay Lipstick</h2>
						<div class="rating three-star mb-2"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> 4.5 (43 reviews)</div>
                        <h4><del>₹1700.00</del><span>55% off</span></h4>
                        <h3>₹750.00</h3>
        ...
        <div class="slide-6">
            <div class="">
                <div class="product-box">
                    <div class="img-block">
					 <a href="#"><img src="../assets/images/icon/share.png" class="img-fluid" alt="share" title="Share more- Save more" ></a>
