					    ...
					    <div class="card-body card-body--padding--1">
					      ...
					      <div class="form-row">
					        <div class="form-group col-md-6">
					          ...
					          <input type="text" class="form-control txtOnly" id="checkout-full-name"  name="name"  value="{{$address->name}}" required>
					        </div>
					        <div class="form-group col-md-6">
					          <label for="checkout-phone">Phone</label>
					          <input type="number" class="form-control notext" id="checkout-phone"  name="phone" maxlength="10" value="{{$address->phone}}" required>
					        </div>
					      </div> 
                           <div class="form-row">
					        <div class="form-group col-md-6">
					          <label for="checkout-email">Email</label>
					          <input type="email" class="form-control" id="checkout-email" placeholder="Email" name="email" value="{{$address->email}}" required>
					        </div> 
					      </div>  
						  ...
						  <div class="form-group col-md-6">
					        <label for="checkout-city">Town / City</label>
					         <select id="checkout-city" class="form-control form-control-select2" name="city" required>
								...
								@foreach($cities as $r) 
									<option value="{{$r->city_name}}" @if($r->city_name == $address->city)selected @endif>{{$r->city_name}}</option>  
								@endforeach 
							</select> 
					      </div>
