					...
					<div class="card-body card-body--padding--2">
						...
						<form method="POST" action="{{ url('guest-login') }}" role="form" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input id="signup-email" type="text" class="form-control @error('phn_or_email') is-invalid @enderror form-control-sm" name="phn_or_email" value="{{ old('email') }}" required autocomplete="email" autofocus>
								@error('phn_or_email')
