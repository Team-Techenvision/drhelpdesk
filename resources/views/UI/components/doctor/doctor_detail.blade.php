				...
				<div class="doctor-widget">
					...
					<div class="doc-info-right">
						...
						<div class="doctor-action">										
							<a href="{{route('start_chat', ['consult_call'=>$consult_call])}}" target="_blank" class="btn btn-white msg-btn" title="You can consult {{$consultation_credit}} times">
						...
						<div class="clinic-booking">
							...
							@if(!$is_doc_has_credit)
							    <div>Doctor is not available for Consult</div>
								...
								<div class="write-review">
									...
									<!-- Write Review Form --> 
										...
										<div class="form-group">
											...
											<input class="form-control" required type="text" placeholder="If you could say it in one sentence, what would you say?" name="title" autocomplete="off">
										</div>
										<div class="form-group">
...
<div class="modal fade" id="consult_now_wallet" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	  <form method="POST" action="{{ url('user-payment') }}" role="form"  class="account-menu__form" id="login_form" enctype="multipart/form-data">
	  <input type="hidden" id="doc_id" name="doc_id" value="{{!empty($doc_id) ? $doc_id:''}}">
		<input type="hidden" id="user_id" name="user_id" value="{{!empty($user_id) ? $user_id:''}}">
            ...
            ?>
	        <input type="hidden" id="call_back" name="call_back" value="{{$url}}">
          @csrf
		...
		<input id="header-amount" type="number" class="form-control form-control-sm" placeholder="Amount" name="amount" value="10" min="10" required autofocus> 
