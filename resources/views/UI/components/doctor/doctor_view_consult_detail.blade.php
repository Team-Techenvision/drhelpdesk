		...
		<div class="block-header__body">
			<nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
				<ol class="breadcrumb__list">
					...
					<li class="breadcrumb__item breadcrumb__item--current breadcrumb__item--last" aria-current="page"><span class="breadcrumb__item-link">Doctor Consult History</span>
					</li>
	...
	<div class="container"> 
		...
		<div class="row">
			...
			<div class="col-md-7 col-lg-8 col-xl-9">  
				<div class="row">
					<div class="col-md-12">
						<h4 class="mb-4">Patient Consultations Details</h4>
													...
													<tbody>
        												...
        												@foreach($consult_history as $r)
															...
															<tr>
																...
																<td> 
																	@if($r->type == 1)
																	<a href="{{route('start_doc_chat')}}" target="_blank" class="btn btn-white msg-btn" title="Chat">
