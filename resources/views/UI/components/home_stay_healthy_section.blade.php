        ...
        <div class="block-posts-carousel__item">
          <div class="post-card">
            <div class="post-card__image">
              <a href="{{url('/blog-detail/'.$r->blogs_id)}}">
            ...
            <div class="post-card__content">
              ...
              <div class="post-card__title">
                <h2><a href="{{url('/blog-detail/'.$r->blogs_id)}}">{{$r->blog_title}}</a></h2>
              </div>
              <!-- <div class="post-card__date">By <a href="#">Jessica Moore</a> on October 19, 2019</div> -->
              <div class="post-card__excerpt">
                <div class="typography"><a href="{{url('/blog-detail/'.$r->blogs_id)}}">{!!$r->blog_description!!}</a></div>
              </div>
 				<div class="post-card__more"><a href="{{url('/blog-detail/'.$r->blogs_id)}}" class="btn btn-secondary btn-sm">Read more</a>
              </div>
            </div>
          </div>
        </div>
