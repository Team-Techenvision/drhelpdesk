<?php  
	$order_item = DB::table('orders')->where('order_id',$user->order_id)->first();  
	if($user->type == 1){
        $status = DB::table('order_status')->where('status_value',$user->order_status)->where('type',1)->pluck('status_name')->first(); 
    }
    elseif($user->type == 2 || $user->type == 3){
        $status = DB::table('order_status')->where('status_value',$user->order_status)->where('type',2)->pluck('status_name')->first();  
    }
?>
...
<html xmlns="https://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head> 
		...
		<style type="text/css">
			...
			.btn{ padding: 14px;font-size: 16px;font-weight: 600; background: #1d99b5; color: #fff;border: 1px solid #fff; }
			.btn:hover{ background:#0b6c82}
					...
					<td valign="top" align="center">
						<table class="em_main_table" style="width:700px;" width="700" cellspacing="0" cellpadding="0" border="0" align="center"> 
							<tbody>
								<tr>
									<td style="padding:15px;" class="em_padd" valign="top" bgcolor="#1d99b5" align="center">
										<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
											<tbody>
												<tr>
													<td style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:15px; color:#fff;" valign="top" align="center">DrHelpDesk| 
														<a href="https://www.drhelpdesk.in" target="_blank" style="color:#fff; text-decoration:underline;">View Online</a>
													</td>
												</tr>
											</tbody>
										</table>
									...
									<td valign="top" align="center">
										<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="background:#fff;">
											<tbody>
												<tr>
													<td valign="top" align="center">
														<img class="em_img" alt="merry Christmas" style="display:block; font-family:Arial, sans-serif; font-size:30px; line-height:34px; color:#000000; background:#fff; max-width:265px;" src="{{asset('UI/images/img/logo.png')}}" width="265" border="0" height="150">
													</td>
												</tr>
											</tbody>
										</table>
								...
								<tr>
									<td style="padding:25px 50px 24px;border:1px solid #121943;" class="em_padd" valign="top" bgcolor="#fff" align="center">
										<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
											<tbody>
												<tr>
													<td style="font-family:'Open Sans', Arial, sans-serif; " valign="top" align="center">
                                                    <button class="btn"><a href="https://drhelpdesk.in/" style="color:white;">Manage Your Order</a></button>
													</td>
												</tr>
												<tr>
												...
												<tr>
													<td style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:18px; color:#121943;  padding-bottom:12px;" valign="top" align="center">Hey 		{{ucfirst($order_item->user_name)}}.<br>
														<br> We are happy to let you know that an item from your order has been {{ucfirst($status)}}.				
													</td>
												</tr>
												<tr>
												...
												<tr>
													<td style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:18px; color:#121943;  padding-bottom:12px;" valign="top" align="center">ORDER NO. {{$user->order_id}}<br><!-- <span style="color:#444">14/7/2020</span> -->
													</td>
												</tr>
								...
								<tr>
									<td style="padding:9px 50px 4px; color:#444;border:1px solid #121943;" class="em_padd" valign="top" bgcolor="#fff">Your Rewards with this Order
									</td>
								</tr>
									...
									<td style="padding:25px 50px 24px; color:#121943;border:1px solid #121943;" class="em_padd" valign="top" bgcolor="#fff" >
										<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
											<tbody>
												...
												<tr>
													<td>
														<img src="{{asset('UI/images/img/coin.png')}}" alt="product" width="32" height="32">
													</td>
													<td>You earn @if($user->earn_dewallet_coin != null) {{$user->earn_dewallet_coin}}@endif @if($user->earn_dewallet_coin == null)0 														@endif Dcoins</td>
								...
								<tr>
									<td style="padding:9px 50px 4px; color:#444;border:1px solid #121943;" class="em_padd" valign="top" bgcolor="#fff">Item Order</td>
								</tr>
								<tr style="border-top:1px solid #ccc ; border-bottom:1px solid #ccc;">
									<td style="padding:25px 50px 24px; color:#121943;border:1px solid #121943;" class="em_padd" valign="top" bgcolor="#fff" >
										<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
											<tbody>
												...
												<tr>
													<td>
														@if($user->product_image != null)
															<img src="{{asset($user->product_image)}}" alt="product" width="80" height="90">
														@else
								...
								<tr style="border-top:1px solid #ccc ; border-bottom:1px solid #ccc;">
									<td style="padding:25px 50px 24px; color:#fff" class="em_padd" valign="top" bgcolor="#121943" >
										<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
											<tbody>
												<tr>
													<td style="text-align:center">Thanx for using DR Help Desk</td> 
												</tr> 
											</tbody>
										</table>
									</td>
											...
											<tbody>
												...
												<tr>
													<td style="font-family:'Open Sans', Arial, sans-serif; font-size:11px; line-height:18px; color:#999999;" valign="top" align="center"><a href="{{url('privacy-policy')}}" target="_blank" style="color:#999999; text-decoration:underline;">PRIVACY STATEMENT</a> | <a href="{{url('term-conditions')}}" target="_blank" style="color:#999999; text-decoration:underline;">TERMS OF SERVICE</a> | <a href="{{url('refund-policy')}}" target="_blank" style="color:#999999; text-decoration:underline;">RETURNS</a>
														<br>
														© 2020 Aensa Health Solutions. All Rights Reserved.<br>
