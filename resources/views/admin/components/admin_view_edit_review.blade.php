...
<div class="col-md-6"> 
	<div class="box box-primary">
		...
		<form action="{{url('save-edit-review')}}" method="post"  enctype="multipart/form-data">
			{{ csrf_field() }}  
			<div class="box-body"> 
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="review-author" placeholder="Your Name" name="user_name" value="{{$review->user_name}}"  >
...
<!--             <div class="form-group">
            	 ...
            	 <div class="form-group">
				    ...
				    <textarea class="form-control" id="user-review" rows="6" name="user_review" >{{$review->comment}}</textarea>
				</div> 
            <div class="form-group">
					<label for="review-text">Reply  Review</label>
				    <textarea class="form-control" id="review-reply" rows="6" name="reply">{{$review->reply}}</textarea>
				</div> 
			</div>  
