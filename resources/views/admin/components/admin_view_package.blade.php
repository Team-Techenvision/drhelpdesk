      ...
      <tbody> 
        ...
        <tr>
          ...
          <td>
            ...
            @endif 
            @if($r->package_type == 1)
              <a href="{{ url('package-status/0/'.$r->id) }}" class="btn btn-primary btn-xs">Popular Package</a> 
            @else
              <a href="{{ url('package-status/1/'.$r->id) }}" class="btn btn-warning btn-xs">Normal Package</a> 
            @endif 
          </td>
        </tr>
        @endforeach
