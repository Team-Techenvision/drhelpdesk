<div class="col-md-6"> 
	<div class="box box-primary">
		<div class="box-header with-border">
			...
			<a href="{{url('view-user-data')}}" class="btn btn-sm btn-success" style="float:right; color:white;">View User Details</a> 
		</div> 
		<form action="{{url('user-details-submit')}}" method="post"  enctype="multipart/form-data" onsubmit="return myFun()">
			...
			<div class="box-body"> 
				...
				<div class="form-group">
					<label>Email</label>
					<input type="email" class="form-control" name="email" value="{{$result->email}}" readonly> 
					@error('email')
                     	<p style="color:red;">* {{ $message }}</p>
                	@enderror
				</div>  
				<div class="form-group">
					<label>Mobile</label>
					<input type="number" class="form-control" name="phone" value="{{$result->mobile}}" readonly>
