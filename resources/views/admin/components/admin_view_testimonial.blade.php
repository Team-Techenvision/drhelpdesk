      ...
      <tbody> 
        ...
        <tr>
          ...
          <td>
            ...
            <a href="{{url('edit-testimonials/'.$r->testimonials_id)}}" class="btn btn-primary btn-xs" title="edit"><i class="fa fa-edit"></i></a>
            <a href="{{url('delete-testimonials/'.$r->testimonials_id)}}" class="btn btn-danger btn-xs" title="delete"><i class="fa fa-trash"></i></a>
            @if($r->status == 1)
