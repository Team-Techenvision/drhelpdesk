      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody> 
          ...
          <tr>
            ...
            <td>Email: {{$r->email}}<br> Mobile Number: {{$r->mobile}} <br> @if($r->landline != null)Landline Nuxmber: {{$r->landline}} @endif</td>  
            ...
            <td>
              <a href="{{url('edit-delivery-boy/'.$r->id)}}" class="btn btn-primary btn-xs" title="edit"><i class="fa fa-edit"></i></a>
              <a href="{{url('delete-delivery-boy/'.$r->id)}}" class="btn btn-danger btn-xs" title="delete"><i class="fa fa-trash"></i></a>
              @if($r->status == 1)
