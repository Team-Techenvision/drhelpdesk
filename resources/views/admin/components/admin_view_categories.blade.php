      ...
      <div class="box-body  table-responsive">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            @php
            $delete_check = DB::table('categories')->where('parent_id',$r->categories_id)->first();
            @endphp
            <tr>
              <td>{{$count++}}</td>
              ...
              <td>
                ...
                <a href="{{url('delete-categories/'.$r->categories_id)}}" class="btn btn-danger btn-xs" title="delete"><i class="fa fa-trash"></i></a>
                @else
                <a href="{{url('delete-categories/'.$r->categories_id)}}" class="btn btn-danger btn-xs disabled" title="delete"><i class="fa fa-trash"></i></a>
                @endif
                @elseif($r->type == 2)
