      ...
      <tbody> 
        ...
        <td> <?php echo $username;  ?></td>
          ...
          <td>
            ...
            @elseif($r->order_status == 3 || $r->order_status == 6 )
          ...
          <td>  
            ...
            @elseif($r->quick_delivery == 1)  
              <a href="https://play.google.com/store/apps/details?id=com.expertwebtech.mydhd.dhd"  class="btn btn-xs bg-primary text-white" target="_blank"> Track Order</a> 
            @endif 
            <a href="{{url('/view-order-details-tester/'.$r->order_id)}}" class="btn btn-xs bg-primary text-white">Order Details</a> 
