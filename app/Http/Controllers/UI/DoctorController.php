...
class DoctorController extends Controller {
    ...
    public function doctoreducation(Request $req) {
        ...
        return redirect('https://drhelpdesk.in/doctor-profile-setting');
    }
    ...
    public function doctorAppointment(Request $req) {
        ...
        $data['appointment'] = ConsultationTransaction::where('doc_id', Auth::user()->id)->orderBy('id', 'desc')->limit(1)->get();  
    ...
    public function doctorLisetAjax(Request $req) {
        ...
        foreach ($details as $r) {
 		$dr = '';
		if (strpos($r->user_name, 'Dr.') === false) {
    			$dr = 'Dr ';
			}
       ...
       $icon22 = '';
        if($r->image != null && file_exists($r->image)){
            $icon22 = "<img src=\"".asset($r->image)."\" class=\"img-fluid\" alt=\"Speciality\">";
                ...
                $icon22 = "<img src=\"https://drhelpdesk.in/upload/userdetails/profile1568027001.jpeg\" class=\"img-fluid\" alt=\"Speciality\">"; 
             }
             $title = "";
            if($speciality_name) {
                $title = $speciality_name->title;
            }
                        ...
                        <div class=\"doctor-widget\">
                            <div class=\"doc-info-left\">
                                ...
                                <div class=\"doc-info-cont\">
                                    <h4 class=\"doc-name\"><a href=\"#\"> " .$dr. $r->user_name . "(" . $title . ")</a></h4>
