...
class MainController extends Controller
{
    ...
    public function homePage(Request $request){  
        ...
        ->select('products.*', 'product_images.product_images_id','product_images.product_image','product_images.type', 'product_attributes.id', 'product_attributes.price','product_attributes.special_price','product_attributes.id')
        ...
        // dd($data['off_product']);
         ...
         ->leftjoin('product_images', 'products.products_id', '=', 'product_images.products_id') 
         ->leftjoin('order_items', 'products.products_id', '=', 'order_items.prod_id')  
         ->leftjoin('product_attributes', 'products.products_id', '=', 'product_attributes.products_id')     
        //  ->select('products.*', 'product_images.*', 'COUNT(order_items.prod_id) AS Maxvisit')
         ->select(array('products.*', 'product_images.product_images_id','product_images.product_image','product_images.type','product_attributes.id', 'product_attributes.price','product_attributes.special_price', DB::raw('COUNT(order_items.prod_id) as Maxvisit')))
        //  ->where('products.status',0)
        ->where('products.categories',14)
