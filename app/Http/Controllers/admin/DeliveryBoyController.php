...
class DeliveryBoyController extends Controller
{
    ...
    public function  deleteDeliveryBoy($id){ 
         $result = DeliveryBoy::where('id',$id)->first(); 
...
//     } 
	public function deliveryBoySubmit(Request $req){  
        ...
        //dd($data);
            ...
            Mail::send('emails.delivery-boy-reg_mail', ['user' => $user], function($message) use ($to_name1, $to_email1) {
